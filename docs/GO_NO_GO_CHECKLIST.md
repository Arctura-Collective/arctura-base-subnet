...
- [x] `pytest tests/ -q` passes with no failures (287 tests on 2026-08-24)
...
- [ ] `arctura-readiness-audit` returns `ok: true` for the reviewed evidence,
  ...
  artifacts
- [ ] `arctura-mainnet-approval` packet generated from green aggregate
  readiness, green evidence, and a Finney burn-cost snapshot collected within
  30 minutes
